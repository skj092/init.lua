...
-- Function definitions (handle_open_router_spec_data, custom_make_openai_spec_curl_args, etc.)
-- Copy these from the original configuration
function handle_open_router_spec_data(data_stream)
...
-- LLM function definitions (llama_405b_base, groq_replace, groq_help, etc.)
function custom_make_openai_spec_curl_args(opts, prompt)
    local url = opts.url
